...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 MySqlCommand^ cmdDataBase3=gcnew MySqlCommand("insert into try1.login password values('"+this->textBox3->Text+"') where (name='"+this->textBox1->Text+"' and security='"+this->textBox2->Text+"'); ",conDataBase); 
